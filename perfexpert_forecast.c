...
//Creating Table
c_snprintf = snprintf(sql,4096,"CREATE TABLE database1.db (ID INT PRIMATY KEY NOT NULL UNIQUE,ARCHITECTURE INT NOT NULL
...
int given_counter,age,c_snprintf,c_snprintf2,counter,id,edit_option;
char name[35];
